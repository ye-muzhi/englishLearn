...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "editor.title": {"en": "Edit subtitles", "zh": "编辑字幕"},
    "editor.select": {"en": "Subtitle", "zh": "选择字幕"},
    "editor.source": {"en": "Original", "zh": "原文"},
    "editor.target": {"en": "Translation", "zh": "译文"},
    "editor.start": {"en": "Start time (s)", "zh": "开始时间（秒）"},
    "editor.end": {"en": "End time (s)", "zh": "结束时间（秒）"},
    "editor.save": {"en": "Save changes", "zh": "保存修改"},
    "editor.saved": {"en": "Subtitle saved.", "zh": "字幕已保存。"},
    "editor.undo": {"en": "Undo", "zh": "撤销"},
    "editor.redo": {"en": "Redo", "zh": "重做"},
    "editor.history": {"en": "Undo {undo} · Redo {redo}", "zh": "可撤销 {undo} · 可重做 {redo}"},
    "editor.split_position": {"en": "Split after character", "zh": "在第几个字符后拆分"},
    "editor.split": {"en": "Split subtitle", "zh": "拆分字幕"},
    "editor.split_invalid": {"en": "Choose a split point with text on both sides.", "zh": "拆分位置两侧都必须有文字。"},
    "editor.merge_hint": {"en": "Combine this cue with the following cue.", "zh": "将当前字幕与下一条合并。"},
    "editor.merge_next": {"en": "Merge next", "zh": "合并下一条"},
    "editor.merge_invalid": {"en": "There is no following subtitle to merge.", "zh": "当前字幕后面没有可合并的字幕。"},
    "editor.retranslate_selected": {"en": "Retranslate selected subtitle", "zh": "仅重新翻译当前字幕"},
    "editor.retranslate_queued": {"en": "Selected subtitle queued for translation.", "zh": "当前字幕已加入后台翻译任务。"},
